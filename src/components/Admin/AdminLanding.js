  ...
  render() {
    ...
    return (
      <section className="">
        <MainHeader/>
        <h1>Image Source</h1>
        <input value={this.state.editClicked ? this.state.imageInput : null} onChange={this.handleImageInput} type="text"/>
        <br/>
        <h1>Title</h1>
        <input value={this.state.editClicked ? this.state.titleInput : null} onChange={this.handleTitleInput} type="text"/>
        <br/>
        <h1>Description</h1>
        <input value={this.state.editClicked ? this.state.descriptionInput : null} onChange={this.handleDescriptionInput} type="text"/>
        <br/>
        <h1>Price</h1>
        <input value={this.state.editClicked ? this.state.priceInput : null} onChange={this.handlePriceInput} type="text"/>
        <br/>
        <h1>Attributes (Attributes should be capitalized and separated by a space only.)</h1>
        <input value={this.state.editClicked ? this.state.attributesInput : null} onChange={this.handleAttributesInput} type="text"/>
        <br/>
